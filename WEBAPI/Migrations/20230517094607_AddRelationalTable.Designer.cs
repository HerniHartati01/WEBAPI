...
{
    [DbContext(typeof(BookingMangementDbContext))]
    [Migration("20230517094607_AddRelationalTable")]
    partial class AddRelationalTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("WEBAPI.Models.Account", b =>
                {
                    b.HasOne("WEBAPI.Models.Employee", "Employee")
                        .WithOne("Account")
                        .HasForeignKey("WEBAPI.Models.Account", "Guid")
            ...
            modelBuilder.Entity("WEBAPI.Models.Education", b =>
                {
                    b.HasOne("WEBAPI.Models.Employee", "Employee")
                        .WithOne("Education")
                        .HasForeignKey("WEBAPI.Models.Education", "Guid")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("WEBAPI.Models.University", "University")
                        .WithMany("Educations")
